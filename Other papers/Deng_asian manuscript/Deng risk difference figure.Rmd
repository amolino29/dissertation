...
**Below is the figure I created from the data in Table 3**. The figure shows the risk differences and 95% CIs for cervical cancer screening completion in the due (light blue) and overdue (orange) screening groups, and then stratified by Asian ethnic subgroup across the x-axis. 
...
ggsave(file="deng_figure.pdf", plot=deng_figure, width=7.5, height=5)
